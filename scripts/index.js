...
const newCardTitle = document.querySelector(".modal__input_type_title");
...
function handleCardSubmit(e){
  e.preventDefault();
  newCardTitle = cardTitleInput.value;
  newCardUrl = cardUrlInput.value;
  renderCard({ Title, Url }, cardListEl);
